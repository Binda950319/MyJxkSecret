 ...
 */
public class ChoiceBournAdatper extends BaseExpandableListAdapter {
    private List<String> groupArray;
    private List<List<String>> childArray;
    private Context context;

    public ChoiceBournAdatper(List<String> groupArray, List<List<String>> childArray, Context context) {
    ...
    public TextView getTextView(String str) {
        ...
        view.setBackgroundResource(R.color.colorWLine);

 ...
 */
public class ShopBournAdatper extends BaseExpandableListAdapter {
    private List<String> groupArray;
    private List<List<String>> childArray;
    private Context context;

    public ShopBournAdatper(List<String> groupArray, List<List<String>> childArray, Context context) {

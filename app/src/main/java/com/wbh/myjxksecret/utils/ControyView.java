 ...
 */
public class ControyView extends View{
    public static final String[] LETTERS = {"热","亚","欧","美","洋","非"};
...
//    }
    ...
    public ControyView(Context context) {
        this(context,null);
    }

    public ControyView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public ControyView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                        mSelectedText.setText(LETTERS[pressedPosition]);
//                    }
//
//                }

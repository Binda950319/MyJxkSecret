...
public class AbcdView extends View{
    ...
    private MyExpandView expandableListView;
...
//    }
    ...
    public AbcdView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setselectedItem(MyExpandView expandableListView){
...
//                        expandableListView.setSelectedGroup(pressedPosition);
                        ...
                        expandableListView.expandGroup(pressedPosition);
//                        posi=pressedPosition;
//                        expandableListView.collapseGroup(posi);
                    }
